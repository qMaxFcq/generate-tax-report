...
async def get_withdraw_history(
    ...
    if responses:
        ...
        all_data["completeTime"] = to_datetime(all_data["completeTime"])
        all_data["completeTime"] += timedelta(hours=7)
        all_data = all_data.sort_values(
            by=["completeTime"], ascending=True
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        await get_withdraw_history(API_KEY, SECRET_KEY, start_date, target_end_date)
